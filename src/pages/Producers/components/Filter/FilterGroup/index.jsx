    ...
    <div>
        ...
        <div className={styles.filter}>
          ...
          <div>
              <div onClick={() => {setOpenMajor(true); setFilterType('major')}} className={styles.filterName}>
                <h3 className={styles.filterH3}>{t('companies.businessCategory')}</h3>
          ...
          <div>
              <div onClick={() => {setOpenMajor(true); setFilterType('place')}} className={styles.filterName}>
                <h3 className={styles.filterH3}>{t('companies.companyLocation')}</h3>
                <IconRight className={styles.iconRight} />
              </div>
              <p className={styles.filterItem}>Не указан</p>
          </div>
      ...
      {openMajor && 
        <div className={styles.filterTool}>
          {filterType === 'major' && 
            <div >
              <div onClick={() => {setOpenMajor(false)}} className={styles.filterName}><IconLeft style={{width: '24px', height: '24px'}}/> <h3>{t('companies.businessCategory')}</h3></div> 
              <div className={styles.filterContent}><MajorFilter setMajor={setMajor} major={major} setOpenMajor={setOpenMajor}/></div>
            </div>
          }
          {filterType === 'place' && 
            <div>
              <div onClick={() => {setOpenMajor(false)}} className={styles.filterName}><IconLeft style={{width: '24px', height: '24px'}}/> <h3>{t('companies.companyLocation')}</h3></div> 
